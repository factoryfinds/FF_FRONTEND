    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (hasNewImages) {
                ...
                const uploadRes = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://192.168.29.110:5000'}/api/upload`, {
                    method: "POST",
                    headers: {
                        "Authorization": `Bearer ${localStorage.getItem("accessToken")}`,
                    },
            ...
            const url = editingProduct
                ...
                : `${process.env.NEXT_PUBLIC_API_URL || 'http://192.168.29.110:5000'}/api/products`;
